...
출력 형식:
• [긍정적 영향 1 — 음슴체, 1~2문장, 구체적 회사·수치 언급]
• [긍정적 영향 2 또는 기회 요인 — 음슴체, 1~2문장]
• [부정적 영향 또는 리스크 — 음슴체, 1~2문장]

규칙:
- 반드시 bullet point(•) 3개로만 출력, 그 외 문장·제목·서론 일절 금지
- 음슴체 엄수 (예: ~임, ~함, ~됨, ~볼 것으로 보임, ~우려됨)
- 각 bullet은 40자 내외로 간결하게
- 경쟁사(SK Hynix·Micron·중국업체) 대비 시사점 포함할 것
