export const SECTIONS = {
  제품: {
    ...
    keywords: {
      DDR: [
        'DDR memory', 'DDR5', 'DDR4', 'RDIMM server memory', 'MRDIMM',
        'SODIMM laptop', 'UDIMM desktop', 'server DRAM', 'DDR5 price',
      ...
      PIM: [
        'processing in memory', 'HBM-PIM', 'LPDDR-PIM', 'CXL-PIM',
  ...
  산업: {
    ...
    keywords: {
      ...
      '지정학·통상': [
        'semiconductor export control', 'China chip restrictions', 'US CHIPS Act',
        'chip tariff', 'China memory makers', 'HBM export control',
        'chip supply chain', 'chip subsidy', 'US China chip war',
        'chip onshoring', 'export license',
      ],
    },
  },
  'Ref.': {
