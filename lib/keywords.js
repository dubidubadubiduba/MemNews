export const SECTIONS = {
  '제품/기술': {
    ...
    keywords: {
      ...
      NAND: [
        'NAND', 'NAND flash', '3D NAND', 'V-NAND', 'QLC NAND',
        'NAND wafer', 'NAND price', 'NAND flash shortage',
        'NAND capacity expansion', 'enterprise NAND', 'NAND contract price',
      ],
      UFS: [
      ...
      CoWoS: [
        'CoWoS', 'CoWoS capacity', 'TSMC CoWoS', 'chip on wafer on substrate',
        'advanced packaging', '2.5D 3D packaging', 'TSV', 'hybrid bonding',
        'HBM packaging', 'co-packaged optics', 'panel level packaging', 'OSAT',
      ],
    },
  },
  응용: {
    ...
    keywords: {
      ...
      'CPU/AP': [
        'CPU', 'application processor', 'Intel Xeon', 'AMD EPYC',
        'Arm server CPU', 'NVIDIA Grace', 'AWS Graviton', 'Ampere Computing',
        'Snapdragon', 'MediaTek Dimensity', 'Apple M series', 'Apple A series',
        'Exynos', 'Google Tensor', 'Intel Core Ultra', 'AMD Ryzen',
      ],
      'AI·데이터센터': [
  ...
  고객: {
    ...
    keywords: {
      ...
      OPPO: [
        'OPPO', 'OPPO Find', 'OPPO Reno', 'OnePlus', 'OPPO foldable',
        'OPPO memory', 'OPPO chip', 'OPPO flagship', 'OPPO AI',
      ],
      vivo: [
        'vivo', 'vivo X', 'iQOO', 'vivo foldable', 'vivo memory',
        'vivo chip', 'vivo flagship', 'vivo AI', 'vivo smartphone',
      ],
      Google: [
...
export const RSS_SOURCES = [
  ...
  // English - Storage / Memory / Datacenter / GPU (무료 직접소스 — 원문 URL O, 전문보기 가능)
  ...
  // Google News 검색 RSS — 반도체 토픽별 (니치 키워드 관련기사 대량 확보)
  { url: 'https://news.google.com/rss/search?q=HBM+memory+when:2d&hl=en-US&gl=US&ceid=US:en' },
  { url: 'https://news.google.com/rss/search?q=DDR5+DRAM+when:2d&hl=en-US&gl=US&ceid=US:en' },
  { url: 'https://news.google.com/rss/search?q=LPDDR+mobile+memory+when:2d&hl=en-US&gl=US&ceid=US:en' },
  { url: 'https://news.google.com/rss/search?q=NAND+flash+memory+when:2d&hl=en-US&gl=US&ceid=US:en' },
  { url: 'https://news.google.com/rss/search?q=GDDR+graphics+memory+when:2d&hl=en-US&gl=US&ceid=US:en' },
  { url: 'https://news.google.com/rss/search?q=CXL+memory+when:2d&hl=en-US&gl=US&ceid=US:en' },
  { url: 'https://news.google.com/rss/search?q=enterprise+SSD+storage+when:2d&hl=en-US&gl=US&ceid=US:en' },
  { url: 'https://news.google.com/rss/search?q=semiconductor+foundry+TSMC+when:2d&hl=en-US&gl=US&ceid=US:en' },
  { url: 'https://news.google.com/rss/search?q=CoWoS+advanced+packaging+when:2d&hl=en-US&gl=US&ceid=US:en' },
  { url: 'https://news.google.com/rss/search?q=AI+data+center+chip+when:2d&hl=en-US&gl=US&ceid=US:en' },
  { url: 'https://news.google.com/rss/search?q=SoC+application+processor+chip+when:2d&hl=en-US&gl=US&ceid=US:en' },
  { url: 'https://news.google.com/rss/search?q=CPU+Xeon+EPYC+Ryzen+when:2d&hl=en-US&gl=US&ceid=US:en' },
  { url: 'https://news.google.com/rss/search?q=memory+chip+market+price+when:2d&hl=en-US&gl=US&ceid=US:en' },
  { url: 'https://news.google.com/rss/search?q=SK+Hynix+when:2d&hl=en-US&gl=US&ceid=US:en' },
  { url: 'https://news.google.com/rss/search?q=Micron+memory+when:2d&hl=en-US&gl=US&ceid=US:en' },
  { url: 'https://news.google.com/rss/search?q=Samsung+semiconductor+memory+when:2d&hl=en-US&gl=US&ceid=US:en' },
  { url: 'https://news.google.com/rss/search?q=NVIDIA+AI+chip+when:2d&hl=en-US&gl=US&ceid=US:en' },
  { url: 'https://news.google.com/rss/search?q=automotive+semiconductor+when:2d&hl=en-US&gl=US&ceid=US:en' },
  { url: 'https://news.google.com/rss/search?q=chip+export+control+CHIPS+Act+when:2d&hl=en-US&gl=US&ceid=US:en' },
]
