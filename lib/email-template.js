    ...
    return `
      <td valign="top" width="50%" style="padding:8px;">
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          ...
          <tr>
            <td valign="top" style="background:#f9f9f9;padding:8px 10px;border:1px solid #e0e0e0;border-top:none;border-radius:0 0 4px 4px;">
              <!-- 고정 높이 + overflow-y:auto → 박스 높이 동일 유지 + (지원 클라이언트에선) 스크롤 -->
              <div style="height:434px;overflow-y:auto;">
    ...
    return `
      <td valign="top" ${full ? 'width="100%"' : 'width="50%"'} style="padding:8px;">
        <table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0" style="height:100%;">
          <tr>
            <td style="background:#0A1931;padding:6px 10px;border-radius:4px 4px 0 0;">
