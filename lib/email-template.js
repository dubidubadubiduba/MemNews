    ...
    return `
      <td valign="top" width="50%" style="padding:8px;">
        <table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0" style="height:100%;">
          ...
          <tr>
            <td valign="top" height="100%" style="height:100%;background:#f9f9f9;padding:8px 10px;border:1px solid #e0e0e0;border-top:none;border-radius:0 0 4px 4px;">
    ...
    return `
      <td valign="top" width="50%" style="padding:8px;">
        <table width="100%" height="100%" cellpadding="0" cellspacing="0" border="0" style="height:100%;">
          ...
          <tr>
            <td valign="top" height="100%" style="height:100%;background:#f9f9f9;padding:10px;border:1px solid #e0e0e0;border-top:none;border-radius:0 0 4px 4px;">
