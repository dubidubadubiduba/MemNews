      ...
      <table width="620" cellpadding="0" cellspacing="0" border="0" style="background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="background:#1428A0;padding:18px 24px;text-align:center;">
            <img src="https://mem-news-pi3h.vercel.app/chipbird-logo-white.png" alt="ChipBird" height="56" style="height:56px;max-height:56px;display:block;margin:0 auto 6px;">
            <p style="margin:0;color:#a0b4e8;font-size:12px;">${dateStr} 오늘의 ChipBird</p>
          </td>
        </tr>
        ...
        <tr>
          <td style="background:#f4f4f4;padding:12px 24px;text-align:center;border-top:1px solid #eee;">
            <p style="margin:0;font-size:11px;color:#aaa;">본 뉴스레터는 매일 오전 6시에 발송됩니다 · ChipBird</p>
          </td>
        </tr>
